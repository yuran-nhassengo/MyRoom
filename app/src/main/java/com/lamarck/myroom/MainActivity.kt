...
import com.lamarck.myroom.entities.relations.SchoolAndDirector
import com.lamarck.myroom.entities.relations.StudentSubjectCrossRef
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch{
          ...
          //  val schoolWithDirector :List<SchoolAndDirector> = dao.getSchoolAndDirectorWithSchoolName("Kotlin School")
